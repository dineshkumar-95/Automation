...
public class CreateSubscriptionRequest {
    ...
    public CreateSubscriptionRequest addSubscriptionItem(SubscriptionItem item) {
    ...
    public CreateSubscriptionRequest addDiscount(Discount discount) {
    ...
    public CreateSubscriptionRequest addItemTier(ItemTier itemTier) {
    ...
    public CreateSubscriptionRequest setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateSubscriptionRequest setBusinessEntityId(String businessEntityId) {
    ...
    public CreateSubscriptionRequest setTrialEnd(Long trialEnd) {
    ...
    public CreateSubscriptionRequest setBillingCycles(Integer billingCycles) {
    ...
    public CreateSubscriptionRequest setMandatoryItemsToRemove(String mandatoryItemsToRemove) {
    ...
    public CreateSubscriptionRequest setNetTermDays(Integer netTermDays) {
    ...
    public CreateSubscriptionRequest setStartDate(Long startDate) {
    ...
    public CreateSubscriptionRequest setAutoCollection(String autoCollection) {
    ...
    public CreateSubscriptionRequest setTermsToCharge(Integer termsToCharge) {
    ...
    public CreateSubscriptionRequest setBillingAlignmentMode(String billingAlignmentMode) {
    ...
    public CreateSubscriptionRequest setOfflinePaymentMethod(String offlinePaymentMethod) {
    ...
    public CreateSubscriptionRequest setPoNumber(String poNumber) {
    ...
    public CreateSubscriptionRequest setCouponIds(String couponIds) {
    ...
    public CreateSubscriptionRequest setPaymentSourceId(String paymentSourceId) {
    ...
    public CreateSubscriptionRequest setOverrideRelationship(Boolean overrideRelationship) {
    ...
    public CreateSubscriptionRequest setInvoiceNotes(String invoiceNotes) {
    ...
    public CreateSubscriptionRequest setInvoiceDate(Long invoiceDate) {
    ...
    public CreateSubscriptionRequest setMetaData(Object metaData) {
    ...
    public CreateSubscriptionRequest setInvoiceImmediately(Boolean invoiceImmediately) {
    ...
    public CreateSubscriptionRequest setReplacePrimaryPaymentSource(Boolean replacePrimaryPaymentSource) {
    ...
    public CreateSubscriptionRequest setFreePeriod(Integer freePeriod) {
    ...
    public CreateSubscriptionRequest setFreePeriodUnit(String freePeriodUnit) {
    ...
    public CreateSubscriptionRequest setContractTermBillingCycleOnRenewal(
    ...
    public CreateSubscriptionRequest setCreatePendingInvoices(Boolean createPendingInvoices) {
    ...
    public CreateSubscriptionRequest setAutoCloseInvoices(Boolean autoCloseInvoices) {
    ...
    public CreateSubscriptionRequest setFirstInvoicePending(Boolean firstInvoicePending) {
    ...
    public CreateSubscriptionRequest setTrialEndAction(String trialEndAction) {
    ...
    public CreateSubscriptionRequest setPaymentInitiator(String paymentInitiator) {
    ...
    public CreateSubscriptionRequest setShippingAddress(ShippingAddress shippingAddress) {
    ...
    public CreateSubscriptionRequest setStatementDescriptor(StatementDescriptor statementDescriptor) {
    ...
    public CreateSubscriptionRequest setPaymentIntent(PaymentIntent paymentIntent) {
    ...
    public CreateSubscriptionRequest setContractTerm(ContractTerm contractTerm) {
    ...
    public CreateSubscriptionRequest setBillingOverride(BillingOverride billingOverride) {
    ...
    public CreateSubscriptionRequest setSubscriptionItems(List<SubscriptionItem> subscriptionItems) {
    ...
    public CreateSubscriptionRequest setDiscounts(List<Discount> discounts) {
    ...
    public CreateSubscriptionRequest setItemTiers(List<ItemTier> itemTiers) {
